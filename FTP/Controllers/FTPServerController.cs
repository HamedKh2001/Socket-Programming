...
namespace Receiver.Controllers
{
    ...
    {
        private string host = "ftp://172.27.144.1:5100";
        ...
        [HttpGet]
        public IActionResult directoryListSimple(string directory)
        {
            try
            {
                /* Create an FTP Request */
                ...
                try { string[] directoryList = directoryRaw.Split("|".ToCharArray()); return Ok(directoryList); }
                catch (Exception ex) { Console.WriteLine(ex.ToString()); }
            }
            catch (Exception ex) { Console.WriteLine(ex.ToString()); }
            /* Return an Empty string Array if an Exception Occurs */
